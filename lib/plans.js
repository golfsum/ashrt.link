...
export const PLANS = {
  free: {
    ...
    priceLabel: '$0/mo',
    limits: {
      // No lifetime cap. A link you already published keeps working and stops
      // counting against you the moment its month is over, so nobody has to
      // delete last quarter's links to make room for this week's.
      links: Infinity,
      linksPerMonth: 50,
      apiPerDay: 100,
      createPerHour: 30,
